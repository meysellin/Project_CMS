...
class Konten extends CI_Controller {
    ...
    public function simpan(){
        ...
        if($cek<>NULL){
            ...
            <div class="alert alert-success alert-dismissible fade show" role="alert">
			 <i class="ti ti-exclamation-circle me-2"></i> Judul konten sudah ada.....
        ...
        $this->session->set_flashdata('alert','
        <div class="alert alert-success alert-dismissible fade show" role="alert">
			 <i class="ti ti-exclamation-circle me-2"></i> Berhasil menambahkan konten.....
		</div>
        ');
        redirect('admin/konten');
    }
    ...
    public function delete_data($id){
        ...
        $this->session->set_flashdata('alert','
        <div class="alert alert-success alert-dismissible fade show" role="alert">
			 <i class="ti ti-exclamation-circle me-2"></i> Berhasil menghapus konten.....
		</div>
        ');
        redirect('admin/konten');
    }
