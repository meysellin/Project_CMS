...
<head>
	...
	<!-- plugins:css -->
	<link rel="stylesheet"
		href="<?= site_url('assets/skydash/') ?><?= site_url('assets/skydash/') ?>vendors/feather/feather.css">
	...
	<div class="container-scroller">
			...
			<div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
				...
				<ul class="navbar-nav navbar-nav-right">
					...
					<li class="nav-item nav-profile dropdown">
						<a class="nav-link dropdown-toggle" href="<?= site_url('assets/skydash/') ?>#" data-toggle="dropdown"
							id="profileDropdown">
							<img src="<?= site_url('assets/skydash/') ?>images/faces/face28.jpg" alt="profile" />
						</a>
					...
					<li class="nav-item nav-settings d-none d-lg-flex">
						<a class="nav-link" href="<?= site_url('assets/skydash/') ?>#">
		...
		<div class="container-fluid page-body-wrapper">
				...
				<ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" id="todo-tab" data-toggle="tab"
							href="<?= site_url('assets/skydash/') ?>#todo-section" role="tab" aria-controls="todo-section"
							aria-expanded="true">TO DO LIST</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" id="chats-tab" data-toggle="tab" href="<?= site_url('assets/skydash/') ?>#chats-section"
			...
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				<ul class="nav">
					<li class="nav-item">
						<a class="nav-link" href="<?= site_url('assets/skydash/') ?>index.html">
							<i class="icon-grid menu-icon"></i>
							<span class="menu-title">Dashboard</span>
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="collapse" href="<?= site_url('assets/skydash/') ?>#ui-basic"
							aria-expanded="false" aria-controls="ui-basic">
							<i class="icon-layout menu-icon"></i>
							<span class="menu-title">Caraosuel</span>
							<i class="menu-arrow"></i>
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="collapse" href="<?= site_url('assets/skydash/') ?>#form-elements"
						...
						<div class="collapse" id="form-elements">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Konten</a></li>
							</ul>
						</div>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="collapse" href="<?= site_url('admin/user/') ?>" aria-expanded="false"
						...
						<div class="collapse" id="charts">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"> <a class="nav-link" href="pages/charts/chartjs.html">Konfigurasi</a></li>
							</ul>
						</div>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="collapse" href="<?= site_url('assets/skydash/') ?>#tables"
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="collapse" href="<?= site_url('assets/skydash/') ?>#icons"
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="collapse" href="<?= site_url('assets/skydash/') ?>#auth"
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="collapse" href="<?= site_url('assets/skydash/') ?>#error"
						...
						<div class="col-md-12 grid-margin">
							<div class="row">
								<div class="col-12 col-xl-8 mb-4 mb-xl-0">
									<p class="font-weight-bold"><?= $contents ?></p>
									...
									<div class="justify-content-end d-flex">
										<div class="dropdown flex-md-grow-1 flex-xl-grow-0">
											...
											<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
												<a class="dropdown-item" href="<?= site_url('assets/skydash/') ?>#">January - March</a>
												<a class="dropdown-item" href="<?= site_url('assets/skydash/') ?>#">March - June</a>
												<a class="dropdown-item" href="<?= site_url('assets/skydash/') ?>#">June - August</a>
												<a class="dropdown-item" href="<?= site_url('assets/skydash/') ?>#">August - November</a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-md-6 grid-margin stretch-card">
							<div class="card tale-bg">
								<div class="card-people mt-auto">
									<img src="<?= site_url('assets/skydash/') ?>images/dashboard/people.svg" alt="people">
							...
							<div class="card position-relative">
								<div class="card-body">
									<div id="detailedReports" class="carousel slide detailed-report-carousel position-static pt-2"
										...
										<a class="carousel-control-prev" href="<?= site_url('assets/skydash/') ?>#detailedReports"
											role="button" data-slide="prev">
											<span class="carousel-control-prev-icon" aria-hidden="true"></span>
											<span class="sr-only">Previous</span>
										</a>
										<a class="carousel-control-next" href="<?= site_url('assets/skydash/') ?>#detailedReports"
							...
							<div class="card">
								<div class="card-body">
									...
									<ul class="icon-data-list">
										<li>
											<div class="d-flex">
												<img src="<?= site_url('assets/skydash/') ?>images/faces/face1.jpg" alt="user">
												<div>
										...
										<li>
											<div class="d-flex">
												<img src="<?= site_url('assets/skydash/') ?>images/faces/face2.jpg" alt="user">
												<div>
										...
										<li>
											<div class="d-flex">
												<img src="<?= site_url('assets/skydash/') ?>images/faces/face3.jpg" alt="user">
												<div>
										...
										<li>
											<div class="d-flex">
												<img src="<?= site_url('assets/skydash/') ?>images/faces/face4.jpg" alt="user">
												<div>
										...
										<li>
											<div class="d-flex">
												<img src="<?= site_url('assets/skydash/') ?>images/faces/face5.jpg" alt="user">
												<div>
				...
				<footer class="footer">
					<div class="d-sm-flex justify-content-center justify-content-sm-between">
						<span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021. Premium <a
								href="<?= site_url('assets/skydash/') ?>https://www.bootstrapdash.com/" target="_blank">Bootstrap admin
					...
					<div class="d-sm-flex justify-content-center justify-content-sm-between">
						<span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Distributed by <a
								href="<?= site_url('assets/skydash/') ?>https://www.themewagon.com/"
