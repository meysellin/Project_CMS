...
<body>
	...
	<nav class="site-nav sticky-top" style="possition: sticky;">
		<div class="container">
					...
					<div class="container">
						<div class="text-center pb-2">
							<p class="section-title px-5">
								<span class="px-4">Welcome to Meysellin</span>
							</p>
						...
						<div class="row pb-3">
							...
							<div class="col-lg-4 mb-4">
								<div class="card border-0 shadow-sm bm-3">
									...
									<div class="card-body bg-light text-center p-4">
										...
										<div class="d-flex justify-content-center mb-3">
											<small class="mr-3"><i
													class="icon icon-user text-primary"></i><?= $uu['nama'] ?></small>
											<small class="mr-3"><i
													class="icon icon-folder text-primary"></i><?= $uu['nama_kategori'] ?></small>
										</div>
										<a href="<?= base_url('home/artikel/'.$uu['slug']) ?>"
											class="btn btn-primary px-4 mx-auto my-3">Baca
											Selengkapnya</a>
									</div>
								</div>
							</div>
